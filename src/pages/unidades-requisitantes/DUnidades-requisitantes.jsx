...
const DUnidades_requisitantes = () => {
    const { rota } = useParams();
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/unidades-requisitantes/${rota}`);
...
export default DUnidades_requisitantes;