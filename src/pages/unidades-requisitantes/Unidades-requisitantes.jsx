...
const Unidades_requisitantes = () => {
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/unidades-requisitantes/unidades-requisitantes`);
...
export default Unidades_requisitantes;
