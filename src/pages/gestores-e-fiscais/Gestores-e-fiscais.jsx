...
const Gestores_e_fiscais = () => {
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/gestores-e-fiscais`);
...
export default Gestores_e_fiscais;
