...
const DGestores_e_fiscais = () => {
    const { rota } = useParams();
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/gestores-e-fiscais/${rota}`);
...
export default DGestores_e_fiscais;