...
const DTreinamento_para_editores = () => {
    const { rota } = useParams();
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/treinamento-para-editores/${rota}`);
...
export default DTreinamento_para_editores;