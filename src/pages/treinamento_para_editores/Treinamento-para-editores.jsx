...
const Treinamento_para_editores = () => {
    const [post, setPost] = React.useState(null);

    React.useEffect(() => {
        async function getPost() {
            const response = await axios.post(`https://apps.tre-ce.jus.br/api-portal-de-compras/treinamento-para-editores`);
...
export default Treinamento_para_editores;
