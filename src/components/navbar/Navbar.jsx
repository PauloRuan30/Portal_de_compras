      ...
      <nav id="header" className="mx-auto p-1 px-5 w-full top-0 text-black">
        <div className="w-full mx-auto flex flex-wrap items-center justify-between mt-0">
          <div className="pl-4 flex items-center">
            ...
            >
              <img className="h-20 pr-2 fill-current inline" src={process.env.PUBLIC_URL + "/Marca_TRE.svg"} alt="Logo" />
              Portal de Compras
            </a>
          </div>
                  ...
                  return (
                    ...
                    >
                      <NavLink
                        ...
                        style={{ color: hoverStates[index] ? 'green' : 'black' }}
                        to={itemUrl.replace("/portal-de-compras/","/")}
                      >
                        {itemName}
                      </NavLink>
                      {hoverStates[index] && item.elements && item.elements.length > 0 && <Dropdown item={item} />}
                    </div>
                  </li>
