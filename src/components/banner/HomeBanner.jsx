        ...
        <div id="div_geral">
            <div class="py-5 pt-20 bg-gradient-to-r from-green-800 to-green-700">
                <div class="px-20 flex flex-wrap flex-col md:flex-row items-center bg-gradient-to-r from-green-800 to-green-700">
                    ...
                    Bem-vindo ao nosso portal de compras, uma plataforma dedicada à transparência e conformidade nas aquisições públicas.<br/>
                    Aqui, buscamos facilitar o acesso a informações sobre licitações, dispensas eletrônicas, obras, e serviços,<br/> 
